...
if [ ! `echo ${PATH} | grep x86_64-softvm-linux` ]; then
	export PATH=${SYSROOT_NATIVE}/usr/bin/:${SYSROOT_NATIVE}/usr/bin/x86_64-softvm-linux:${PATH}
fi
...
export CROSS_COMPILE=x86_64-softvm-linux-
